...
public class PayInfo {
	...
	private PayInfo(UnifiedOrderReqDataBuilder builder) {
		this.appid = builder.appid;
		this.mch_id = builder.mch_id;
		this.device_info = builder.device_info;
		this.nonce_str = UUID.randomUUID().toString().substring(0, 31);
	...
	public static class UnifiedOrderReqDataBuilder {
		 ...
		 * @param trade_type
		 */
		public UnifiedOrderReqDataBuilder(String body, String out_trade_no, Integer total_fee, String spbill_create_ip,
				String notify_url, String trade_type) {

			this(TicketUtil.appid, TicketUtil.mch_id, body, out_trade_no, total_fee, spbill_create_ip,
