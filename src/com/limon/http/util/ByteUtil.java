 ...
 * @FileName: util.java 
 * @Package:socketlong 
 * @Description: 字符、整形、byte转换包
 * @author: m_lm@163.com  
 * @date:2012-8-26 下午09:51:21 
 * @version V1.0 
 * Copyright (c) 2012 GZSOFT,Inc. All Rights Reserved.
 */
...
public class ByteUtil {
	...
	public static String Lac82Lac5(int lac8){
		String lac5=lac8+"";
		lac5=Hex2Int(Int2Hex(lac8).substring(4))+"";
		return lac5;
	}
	...
	public static void main(String[] args){
		...
		body = ut.Hex2Bytes(ut.Str2Hex(str));
		
		try {
			ut.printHexString(ut.LinkByte(b, body, b));
		} catch (Exception e) {
